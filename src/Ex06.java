...
//        ArrayList<int> list2 => x
        ArrayList<Integer> list2 = new ArrayList<>();
        // ArrayList<참조 타입> -> 대문자로 시작하는 형태
        // int -> Integer, char -> Character
        // 나머지는 원래 호칭과 기본 타입 키워드가 일치하므로 맨앞 글자만 대문자로만 바꿔주면 된다.
        List<String> list3 = new ArrayList<>(); // 뒤의 <> -> 변수 타입을 따라가므로 생략
...
//        System.out.println("list.get(1) = " + list.get(1)); // 없는 index 호출 시
        // Exception in thread "main" java.lang.IndexOutOfBoundsException: Index 1 out of bounds for length 1
        list.remove(0);
        System.out.println("list = " + list);
        System.out.println("list.size() = " + list.size());
        List<Integer> list4 = List.of(1, 2, 3, 5, 8, 13); // -> 가장 대표적인 방법
